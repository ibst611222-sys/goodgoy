...
export default function PortfolioPage() {
  const { portfolioHoldings, displayCurrency, exchangeRates } = useAppStore()
              ...
              >
                ...
                <div className="flex-1 grid grid-cols-5 gap-2 text-[10px] font-mono">
                  ...
                  <div>
                    ...
                    <div className={pl >= 0 ? 'text-neon-green' : 'text-neon-pink'}>{formatCurrency(cv(pl), displayCurrency)}</div>
                  </div>
                  <div>
